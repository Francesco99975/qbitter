...
abstract class $ServerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, String token});
}
...
class _$ServerImpl implements _Server {
  const _$ServerImpl({required this.url, required this.token});
  ...
  @override
  String toString() {
    return 'Server(url: $url, token: $token)';
  }
...
abstract class _Server implements Server {
  const factory _Server(
      {required final String url, required final String token}) = _$ServerImpl;
